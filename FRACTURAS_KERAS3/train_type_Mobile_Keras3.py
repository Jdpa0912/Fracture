...
print("Inicio modelo de tipo de fractura")

IMG_SIZE = (224, 224)
DATASET_DIR = "TypeTrain"
OUTPUT_DIR = "output"
MODEL_PATH = os.path.join(OUTPUT_DIR, "fracture_type.keras")
PLOT_PATH = os.path.join(OUTPUT_DIR, "fracture_type_plot.png")

print("[INFO] Loading type images...")
data = []
labels = []
...
print("[INFO] Preparing type model...")
...
print("[INFO] Training type model...")
...
print("[INFO] Evaluating type model...")
...
plt.title("Fracture Type - Training Loss and Accuracy")
plt.xlabel("Epoch")
